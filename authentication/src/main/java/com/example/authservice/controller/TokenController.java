...
public class TokenController {
	...
	@PostMapping("/token")
	public ResponseEntity<?> getToken(@RequestBody user login) throws ServletException {
		...
		Optional<user> clientFromDb = Optional.ofNullable(userRepository.findByUsername(name));
